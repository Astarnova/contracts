...
/**
 * This is a sample contract to be used in the NovaDistributorV2 contract for partners to reward
 * stakers with their native token alongside NOVA.
 *
 * It assumes no minting rights, so requires a set amount of YOUR_TOKEN to be transferred to this contract prior.
 * E.g. say you've allocated 100,000 XYZ to the NOVA-XYZ farm over 30 days. Then you would need to transfer
...
contract SimpleRewarderPerSec is IRewarder, Ownable, ReentrancyGuard {
    ...
    IMasterChef public immutable distributorV2;
    ...
    modifier onlyDistributorV2() {
        require(
            ...
            "onlyDistributorV2: only NovaDistributorV2 can call this function"
        );
        _;
    }
    ...
    constructor(
        ...
        require(
            ...
            "constructor: NovaDistributorV2 must be a valid contract"
        );
    ...
    /// @notice Function called by NovaDistributorV2 whenever staker claims NOVA harvest. Allows staker to also receive a 2nd reward token.
    /// @param _user Address of user
    /// @param _lpAmount Number of LP tokens the user has
    function onNovaReward(address _user, uint256 _lpAmount)
        external
        override
        onlyDistributorV2
        nonReentrant
